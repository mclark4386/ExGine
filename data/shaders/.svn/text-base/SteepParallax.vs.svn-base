...
void main()
{
	...
	vec4 wsEyePos = gl_ModelViewMatrix *gl_Vertex;
	...
	vec3 eyeDirection = textureSpaceMatrix * normalize(-wsEyePos.xyz);
	lightDirection = textureSpaceMatrix * normalize(lightPosition - wsEyePos.xyz);
