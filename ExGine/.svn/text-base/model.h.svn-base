...
public:
	...
	void draw(glslProgram* shaderProgram, bool textured); //function to callback
...
Model::Model():BufferSize(5),VertCount(0)
{	
	name = "test-plane.em";
...
void Model::draw(glslProgram* shaderProgram = NULL, bool textured = true)
{	
...
Model::Model(mFile* myM):BufferSize(5),VertCount(0)
{
...
Model::Model(string _name):BufferSize(5),VertCount(0)
{
	name = _name;
	mFile* myM=new mFile(name.c_str());
	//myM->print();//test
