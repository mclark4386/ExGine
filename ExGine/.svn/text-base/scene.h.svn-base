...
{
public:
	Scene(){/*testGUI = new Gui();*/currentShaderID = 0;fbo = NULL;offset = blink= doFPS = pickMode=toFbo=false;root=current=0;full=0;lightToggle=toggle=count=0;worldRot.x = 0;worldRot.y = 0;worldRot.z = 0;worldPos.x = 0;worldPos.y = 0;worldPos.z = -10;};
